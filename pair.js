...
const config = {
    ...
    IMAGE_PATH: 'https://files.catbox.moe/czzhiv.jpg',
    NEWSLETTER_JID: '120363421468247130@newsletter',
    ...
    BUTTON_IMAGES: {
        ALIVE: 'https://files.catbox.moe/czzhiv.jpg',
        MENU: 'https://files.catbox.moe/czzhiv.jpg',
        OWNER: 'https://files.catbox.moe/czzhiv.jpg',
        SONG: 'https://files.catbox.moe/czzhiv.jpg',
        VIDEO: 'https://files.catbox.moe/czzhiv.jpg'
    }
};
...
const mongoUri = 'mongodb://mongo:ZrmuHSZHIbULPFoqMKfFXFmouHnaHgxI@mongodb.railway.internal:27017/Shanukai';
        ...
        try {
            switch (command) {
                ...
                case 'menu': {
                    ...
                    const title = '┏━━━━ ◉◉ `ʜᴀʟʟᴏᴡ`━━━━ ◉◉➢\n┣ *🧚‍♂️ Name: HASHEN-𝐌ɪɴɪ-𝐁ᴏᴛ\n┣ *🌐 Type:* ᴍɪɴɪ ʙᴏᴛ\n┣ *👨‍💻 Owners:* Cyber - hashen\n┗━⚝';
                    const content = `*©ꜱᴇɴᴜ-x-ᴍɪɴɪ-ᴠ1*\n` +
                                   `*⚝╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾⚝*\n` +
                    ...
                    const sentMsg = await socket.sendMessage(sender, {
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://files.catbox.moe/czzhiv.jpg"',
